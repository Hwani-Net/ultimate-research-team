# 🛸 Antigravity 마스터 매뉴얼 (Universal Portable v11.4)
## AI 어시스턴트를 뼛속까지 부려먹는 궁극의 지침서

> **경고**: 이 문서는 Antigravity(Google Deepmind AI)의 자율 실행 권한을 100% 해금하는 **'Ultimate Soulless Mode v11.4'**의 공식 매뉴얼입니다. 더 이상 여러 버전의 프롬프트를 섞어 쓸 필요가 없습니다. 이 문서 하나면 충분합니다.

---

## 🏆 상징적 유물: 최종 병기 (v11.4 Portable)
...
## �️ 페르소나 및 소통 원칙 (Real-Name Policy)
